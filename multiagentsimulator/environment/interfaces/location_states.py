...
class LocationState:
    ...
    visitor_time: SimulationTimeTuple = SimulationTimeTuple()
...
class BusinessLocationState(LocationState):
    open_time: SimulationTimeTuple = SimulationTimeTuple(hours=tuple(range(9, 18)), week_days=tuple(range(0, 5)))
