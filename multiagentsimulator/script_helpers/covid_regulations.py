...
from ..environment import ChosenRegulation, DEFAULT, Risk, Office, School, University, RetailStore, Restaurant, Bar

austin_regulations: List[ChosenRegulation] = [
...
italian_regulations: List[ChosenRegulation] = [
    ChosenRegulation(stay_home_if_sick=False,
                     practice_good_hygiene=False,
                     wear_facial_coverings=False,
                     social_distancing=DEFAULT,
...
swedish_regulations: List[ChosenRegulation] = [
    ChosenRegulation(stay_home_if_sick=False,
                     practice_good_hygiene=False,
                     wear_facial_coverings=False,
                     social_distancing=DEFAULT,
