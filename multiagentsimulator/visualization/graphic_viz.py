...
from ..environment import PandemicObservation, InfectionSummary, SimulationState, SimulationConfigs
...
class BaseMatplotLibViz(PandemicViz):
    ...
    @classmethod
    def from_config(cls: Type['BaseMatplotLibViz'], sim_config: SimulationConfigs) -> 'BaseMatplotLibViz':
    ...
    def record(self, data: Any) -> None:
        if isinstance(data, SimulationState):
